...
def generate_upgrade_steps_with_support_elevator(environment_groups, upgrade_failure_percentage, maintenance_window):
    df_upgrade_steps = upgrade_cycle.compute_next_upgrade_cycle(
        start_date = datetime.fromisoformat('2020-03-01'),
        environment_groups = environment_groups,
        upgrade_failure_percentage = upgrade_failure_percentage,
    ...
    fig.update_yaxes(secondary_y=True, side='left')
    fig.update_yaxes(secondary_y=False, range=[12,13], side='right', visible=False)
